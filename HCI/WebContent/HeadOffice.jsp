...
<head>
  <meta charset="UTF-8">
  <title>HeadOffice - Sri Lanka Railway</title>
  <!-- Styles -->
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="breadcrumbs">
						<a href="Home.jsp">Home</a><i class="fa fa-angle-double-right"></i><span><a href="Contactus.jsp">Contact Us</a></span><i class="fa fa-angle-double-right"></i><span>Head Office Details</span>
					</div>
					<!-- end of breadcrumbs -->
				</div>
				<!-- end of col -->
...
<div class="container1">
	<br><br><br>
 <h2>HeadOffice Details</h2>
    <br>
    
  <form >
    <p for="fname">Telephone : <a href="#"> +94118763094 </a></p> <br> 
    <p for="lname">Fax N0 :  <a href="#">+94118475090000</a></p><br> 
    <p for="country">Email :  <a href="#">gmr@railway.lk</a></p>   <br>  
    <p for="subject">Railway H/0 No :  <a href="#">+94116354789</a></p><br> 
    <p for="country">Fort Railway Inq :  <a href="#">+94118377590</a></p>  <br> 
    <p for="subject">Deputy Operating Superindent :  <a href="#">+94116354789</a></p><br>  
  </form>
  </div>
