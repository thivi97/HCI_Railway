    ...
    <nav class="navbar navbar-expand-md navbar-dark navbar-custom fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav ml-auto">
               ...
               <!-- Dropdown Menu -->          
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle page-scroll" href="#about" id="navbarDropdown" role="button" aria-haspopup="true" aria-expanded="false">SERVICES</a>
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <img alt="" src="images/progress.gif">
                ...
                <div class="col-md-2">
                    <div class="text-container">
                        ...
                        <ul class="list-unstyled li-space-lg">
                            ...
                            <li>
                               <a class="white" href="#">PASSENGER SERVICE</a>
                            </li>
                            <li class="media">
                                <a class="white" href="#">GOODS & PARCELS</a>
                            </li>
                            <li>
                                <a class="white" href="">RESERVATION</a>
                            </li>
                            <li>
                ...
                <div class="col-md-2">
                    <div class="text-container">
                        ...
                        <ul class="list-unstyled li-space-lg">
                            ...
                            <li>
                                <a class="white" href="#">DEPARTMENT NOTICES</a>
                            </li>
                            <li>
                ...
                <div class="col-md-2">
                    <div class="text-container">
                        ...
                        <ul class="list-unstyled li-space-lg">
                            <li>
                                <a class="white" href="#">HEAD OFFICE DETAILS</a>
                            </li>
                            <li>
                                <a class="white" href="#">STATION DETAILS</a>
                            </li>
                            <li>
