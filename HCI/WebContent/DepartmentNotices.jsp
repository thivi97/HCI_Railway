...
<head>
  <meta charset="utf-8">
    ...
    <title>Department Notices - Sri Lanka Railway</title>
...
<!-- Breadcrumbs -->
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="breadcrumbs">
						<a href="Home.jsp">Home</a><i class="fa fa-angle-double-right"></i><span><a href="#">Notices</a></span><i class="fa fa-angle-double-right"></i><span>Department Notices</span>
					</div>
					<!-- end of breadcrumbs -->
				</div>
				<!-- end of col -->
  ...
  <a href="Contactus.jsp" id="contact">Feedback</a>
	...
	<img src="images/ad.jpeg" align="right" alt="Paris" width="200" height="530" style=" border-radius: 18px; margin-top: 10px; float: right;">
...
<button type="button" class="collapsible">Payments for Railway Warrants</button>
<div class="content" >
...
<br>
<input type="button" id="btnExport" value="Download as PDF" style="background-color: #404473; margin-left: 40%; color: white; border-radius: 10px; padding:8px; " />
</div>
<br><br>

<button type="button" class="collapsible">Recruitment Procedure - 2020</button>
<div class="content" >
<div id="dtBasicExample" style="border-style: solid; border-radius: 15px; padding: 10px;">
<h2 style="text-align:center;">Recruitment Procedure - 2020</h2>
<p style="padding: 20px">
The Traffic Costing Unit functions under the Principal Costing Officer and includes a Statistics Section and a Traffic Costing Section. The function of the Unit is to identify and ascertain cost of services and operations in order to provide management with data to use in tariff fixing and in investment decisions. The Unit analyses and reports operating and revenue statistics and prepares the Annual Report, Railway Facts & Figures, and Summary of Operating and Financial Statistics.
Under operating statistics, records of locomotive, train, and vehicle kilometres are processed and analysed.</p>
<p style="padding: 20px"> Under revenue statistics, passenger journeys, passenger kilometres, tonnage of freight forwarded and tonne kilometres are processed and analysed. The Unit distributes monthly, quarterly, and annual returns of statistical data under the above two categories for the information of Railway management.</p>
...
<button type="button" class="collapsible">Srilanka Railway - Performance Report -2020</button>
<div class="content" >
<div id="dtBasicExample" style="border-style: solid; border-radius: 15px; padding: 10px;">
<h2 style="text-align:center;">Srilanka Railway - Performance Report -2020</h2>
<p style="padding: 20px">
The Traffic Costing Unit functions under the Principal Costing Officer and includes a Statistics Section and a Traffic Costing Section. The function of the Unit is to identify and ascertain cost of services and operations in order to provide management with data to use in tariff fixing and in investment decisions. The Unit analyses and reports operating and revenue statistics and prepares the Annual Report, Railway Facts & Figures, and Summary of Operating and Financial Statistics.
Under operating statistics, records of locomotive, train, and vehicle kilometres are processed and analysed.</p>
<p style="padding: 20px"> Under revenue statistics, passenger journeys, passenger kilometres, tonnage of freight forwarded and tonne kilometres are processed and analysed. The Unit distributes monthly, quarterly, and annual returns of statistical data under the above two categories for the information of Railway management.</p>
...
<button type="button" class="collapsible">Circular for Railway staffs</button>
<div class="content" >
<div id="dtBasicExample" style="border-style: solid; border-radius: 15px; padding: 10px;">
<h2 style="text-align:center;">Circular for Railway staffs</h2>
<p style="padding: 20px">
The Traffic Costing Unit functions under the Principal Costing Officer and includes a Statistics Section and a Traffic Costing Section. The function of the Unit is to identify and ascertain cost of services and operations in order to provide management with data to use in tariff fixing and in investment decisions. The Unit analyses and reports operating and revenue statistics and prepares the Annual Report, Railway Facts & Figures, and Summary of Operating and Financial Statistics.
Under operating statistics, records of locomotive, train, and vehicle kilometres are processed and analysed.</p>
<p style="padding: 20px"> Under revenue statistics, passenger journeys, passenger kilometres, tonnage of freight forwarded and tonne kilometres are processed and analysed. The Unit distributes monthly, quarterly, and annual returns of statistical data under the above two categories for the information of Railway management.</p>
        ...
        $("body").on("click", "#btnExport", function () {
            html2canvas($('#dtBasicExample')[0], {
                onrendered: function (canvas) {
                    ...
                    pdfMake.createPdf(docDefinition).download("Department_notice.pdf");
                }
            });
        });
        </script>
