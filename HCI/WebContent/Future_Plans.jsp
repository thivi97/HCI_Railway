...
<title>Future Plans - Sri Lanka Railway</title>
<!-- Styles -->
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="breadcrumbs">
						<a href="Home.jsp">Home</a><i class="fa fa-angle-double-right"></i><span><a href="Aboutus.jsp">About Us</a></span><i class="fa fa-angle-double-right"></i><span>Future Plans</span>
					</div>
					<!-- end of breadcrumbs -->
				</div>
				<!-- end of col -->
